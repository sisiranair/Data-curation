#to fetch FDA status for the new drugs_with_ids.csv (NCI60+PRISM)
#lab annotation file
drugs_with_ids <- read.csv("data/drugs_with_ids.csv", stringsAsFactors = F)
...
drugNames <- as.data.frame(drugs_with_ids$unique.drugid)
